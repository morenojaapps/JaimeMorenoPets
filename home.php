...
<html>
  <head>
    <title>Home >> JM Fotografía pets</title>
    <meta charset="utf-8">
  ...
  <body class="fondoInicio">
    <header>
                ...
                <div class="form-contact">
                  ...
                  <form>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        <input type="number" class="form-control" id="inputNumber" placeholder="Celular" min="0">
                      </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                      <label class="form-group col-md-3" for="inputState">Estoy interesado en:</label>
                      <div class="form-group col-md-9">
                        <select id="inputState" class="form-control" placeholder="Paquetes">
        ...
        <section>
          <div class="section-start-2  ">
            <div class="section-container-2" >
              <div class="row">
                <div class="col-sm container-2-col-1 animate-section-2">
                  <a href="#"><img src="img/Diseño de fuentes-01.png" alt=""></a>
                </div>
              ...
              <div class="section-container-3">
                <div class="row">
                  ...
                  <div class="col-sm section-container-3-texto animate-section-3">
                    <a href="#"><img src="img/Diseño de fuentes-02.png" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-deck mb-3 text-center">
              <div class="card mb-4 box-shadow animate-section-5">
                <div class="card-header">
                  <h4 class="my-0 font-weight-normal">Paquete Básico</h4>
                </div>
                <div class="card-body">
                  <h1 class="card-title pricing-card-title">$70.000 <small class="text-muted"></small></h1>
                  <ul class="list-unstyled mt-3 mb-4">
                    <li>15 Fotos Digitales</li>
                    <li>1 Fotos 20 x 30</li>
                    <li>3 Fotos 10 x 15</li>
                    <li>Duración 1:00 h. Aprox</li>
                    <br>
                  </ul>
                  <button type="button" class="btn btn-lg btn-block btn-danger">Contratar</button>
                </div>
              </div>
              <div class="card mb-4 box-shadow animate-section-5">
                <div class="card-header">
                  <h4 class="my-0 font-weight-normal">Paquete Pro</h4>
                </div>
                <div class="card-body">
                  <h1 class="card-title pricing-card-title">$100.000 <small class="text-muted"></small></h1>
                  <ul class="list-unstyled mt-3 mb-4">
                    <li>25 Fotos Digitales</li>
                    <li>2 Fotos 20 x 30</li>
                    <li>5 Fotos 10 x 15</li>
                    <li>Duración 1:30 h. Aprox</li>
                    <br>
                  </ul>
                  <button type="button" class="btn btn-lg btn-block btn-danger">Contratar</button>
                </div>
              ...
              <div class="card mb-4 box-shadow animate-section-5">
                <div class="card-header">
                  <h4 class="my-0 font-weight-normal">Paquete Premium</h4>
                </div>
                <div class="card-body">
                  <h1 class="card-title pricing-card-title">$180.000<small class="text-muted"></small></h1>
                  <ul class="list-unstyled mt-3 mb-4">
                    <li>40 Fotos Digitales</li>
                    <li>4 Fotos 20 x 30</li>
                    <li>10 Fotos 10 x 15</li>
                    <li>Revista personalizada</li>
                    <li>Duración 2:00 h. Aprox</li>
                  </ul>
                  <button type="button" class="btn btn-lg btn-block btn-danger">Contratar</button>
                </div>
              </div>
      ...
      <section>
        <div class="section-start-5  ">
          <div class="section-container-5" >
            <div class="row">
              <div class="col-sm container-5-col-1 animate-section-6">
                <a href="#"><img src="img/Diseño de fuentes-03.png" alt=""></a>
              </div>
              <div class="col-sm container-5-col-2">
                <div class="content-gallery-5">
                  <div class="row-user">
                    <div class="col-1-3">
                      <div class="big">
